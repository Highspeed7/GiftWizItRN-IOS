export var config = {
    issuer: 'https://giftwizit.b2clogin.com/giftwizit.onmicrosoft.com/oauth2/v2.0/Authorize',
    ...
    serviceConfiguration: {
        authorizationEndpoint: 'https://giftwizit.b2clogin.com/giftwizit.onmicrosoft.com/oauth2/v2.0/authorize?p=B2C_1_SigninSignup1',
